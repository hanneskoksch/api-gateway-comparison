...
class EchoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamPing = channel.stream_stream(
                '/Echo/StreamPing',
                request_serializer=proto_dot_echo__pb2.EchoRequest.SerializeToString,
                response_deserializer=proto_dot_echo__pb2.EchoReply.FromString,
                _registered_method=True)
...
def add_EchoServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StreamPing': grpc.stream_stream_rpc_method_handler(
                    servicer.StreamPing,
                    request_deserializer=proto_dot_echo__pb2.EchoRequest.FromString,
                    response_serializer=proto_dot_echo__pb2.EchoReply.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('Echo', rpc_method_handlers)
...
class Echo(object):
    ...
    def Ping(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            proto_dot_echo__pb2.EchoReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def StreamPing(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
